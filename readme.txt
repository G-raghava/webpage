...
Description - 
The entire webpage is divided into 9 sections which are mentioned as follows :

Section 1. Introduction 
On a background image, a faded-card is placed at the center with personal details, and a photo.
...
Section 5. Project & Work Experience
Displayed as two cards with a view button that links to the respective pdf documents.
one is in project folder & other one is experinece folder.
Hovering over indiviual cards covers them halfway with a colored screen, mentoned in .js file.

Section 6. Skills
In Skills part there are divided two separate skills they are Programming Skills & Technical Skills
Responsive horizontal bars along each skill that grow on refreshing the page. 

section 7. Achievemnets
Here left side is image and right side matter related to that image.

Section 8. Hobbies
This section includes the images of my hobbies and picturization can easily understand.
